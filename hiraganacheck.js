			...
			if(word.charAt(target.length) === 'っ'){
				...
				if(target.length + 2 < word.length){
					...
					if(poi1 === 'し' && poi2 === 'ょ'){
						...
						// 頑張るっちゃ
						tto = true;
					} else if(poi1 == 'ぷ' && poi2 == 'り'){
						// 'っぷり'
						tto = true;
					} else if(poi1 === 'ぽ' && ('いかきくけ'.indexOf(poi2) !== -1 || poi2_2 == 'そう') ){
						// っぽそう　っぽい っぽく
						tto = true;
					...
					if(-1 < katuyou_type){
						var ext = [
							/* 0書か */ ['されず', 'されそう', 'された', 'されていた', 'されている', 'されてた', 'されてて', 'されてる', 'されてろ', 'されて', 'される', 'され',
								...
								'れてた', 'れてて', 'れてる', 'れてろ', 'れて', 'れど', 'れぬ', 'れる', 'れよう', 'れん', 'れ', 'んとし', 'んとす'],
							/* 1書こ */ ['うっか', 'う', 'っか'],
							...
							/* 4書く*/ ['うちに', 'から', 'かも', 'か', 'ぜよ', 'ぜ', 'なり', 'なんて', 'べく', 'まい', 'まじ', 'より', 'みたい', 'みたかった', 'みたく', ''],
...
//										enable = false;
			...
			var ext = [['き', 'った', 'ってる', 'って', 'る', 'り', 'れちゃ', 'れぬ', 'れず', 'れ', 'ろうか', 'ろう'],
				...
				'くれば', 'くれまい','くれる', 'くれん', 'くれ', 'く', 'た', 'った', 'って', 'て', 'ちゃ',
				'はくれまい',
