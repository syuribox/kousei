					...
					if(-1 < katuyou_type){
						if(global_5dan_ext_set1_arr.length === 0){
							...
							/* 2書き */ ['いただかない', 'いただかなく', 'いただき', 'いただく', 'いただけた', 'いただける', 'いただけ', 'いただこう', 
								'かた', 'がたい', 'がたく', 'きったし', 'きったら', 'きったり', 'きった', 'きってく', 'きってた', 'きってろ', 'きってる', 'きって', 'きる', 'きり',
							...
							/* 3書い書け */ ['たから', 'たきり', 'たし', 'たっけ', 'たっきり', 'たぞ', 'たのち', 'たの', 'たら', 'たわけ', 'た',
						...
						for(const ext_index of ext_indexs){
							...
							for(let w_len = max_len; 0 <= w_len; w_len--){
								...
								if(hit_ex && (ex.length == 0 || suffix.startsWith(ex, 1))){
									...
									const exclude = [
										...
										'てちゃ/んと', 'でちゃ/んと', 'なよ/う', 'てく/れ', 'ちゃ/%わいうえおっ',
										'るし/ろもの',
										'んのよ/く'];
...
//										enable = false;
			...
			if(global_keiyou_siku_ext_arr.length === 0){
				...
				'くても', 'くて',
				'くなぁれ', 'くなあれ',
				'くないし', 'くない', 'くなくても', 'くなくて', 'くなく', 'くなったし', 'くなったら', 'くなったり', 'くなった',
				...
				'ければ', 'げ',
				'さくらい',
				'さだし', 'さだったら', 'さだったり', 'さだったし', 'さだった', 'さだって', 'さだ',
				'さでしたし', 'さでした', 'さですし', 'さです', 'さで', 'さ',
				'そうだから', 'そうだったら〈', 'そうだったり', 'そうだった', 'そうだ', 'そうなら', 'そうな', 'そう',
				'すぎず',
				'すぎたし', 'すぎたら', 'すぎた', 
				'すぎてるし', 'すぎてる', 'すぎて',
			...
			for(long_idx; long_idx < len; long_idx++){
				if(suffix.charAt(long_idx) !== end_char){
					break;
				}
			}
